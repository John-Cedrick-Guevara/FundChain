...
import { submitProposal } from "@/app/(actions)/project";
...
const ProposalForm = ({ sectors }: { sectors: Sector[] }) => {
  const user = useAuth();
  ...
  async function handleSubmit() {
    ...
    const res = await submitProposal(formData, user.id ?? "");

    toast("Project Submitted Successfully!", {
      description:
        "Your project has been submitted for community review. You'll receive an email update soon.",
    });
